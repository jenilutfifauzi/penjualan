        ...
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-12">
                ...
                <div class="table-responsive">
                  <table id="tabel2" class="table table-striped table-bordered display nowrap" style="width:100%">
                    ...
                    <tbody>
                      <?php
                      $no = 1;
                      foreach ($data_tor as $users) : ?>
                        <tr>
                          <td><?= $no++ ?></td>
                          <td><?= $users['id'] ?></td>
                          <td><?= $users['kode_detail'] ?></td>
                          <td><?= $users['nama_kegiatan'] ?></td>
                          <td><?= $users['keterangan'] ?></td>
                          <td>
                            <a href="<?= site_url('upload/tor/' . $users['dokumen']) ?>"> Lihat</a>
                          </td>
              ...
              <!-- tabel data semula menjadi -->
              <br>
              <div class="card-header">
                <h4>Data Semula Menjadi </h4>
              </div>
              <div>
                  ...
                  <table id="tabel2" class="table table-striped table-bordered display nowrap" style="width:100%">
                    <thead>
                      <tr>
                        ...
                        <th>Nama Kegiatan</th>
                        <th>Keterangan</th>
                        <th>Data Semula Menjadi</th>
                      </tr>
                    </thead>
                    <tbody>
                      <?php
                      $no = 1;
                      foreach ($data_semulamenjadi as $users) : ?>
                        <tr>
                          <td><?= $no++ ?></td>
                          <td><?= $users['id'] ?></td>
                          <td><?= $users['kode_detail'] ?></td>
                          ...
                          <td><?= $users['keterangan'] ?></td>
                          <td>
                            <a href="<?= site_url('upload/semula_menjadi/' . $users['dokumen']) ?>"> Download</a>
                          </td>
